...
-- Cron registration
select isnt_empty(
  $$ select 1 from cron.job where jobname = 'close_daily_vote_daily' and schedule = '0 15 * * *' $$,
  'close_daily_vote is registered as a daily pg_cron job at UTC 15:00 (JST 24:00)'
);
