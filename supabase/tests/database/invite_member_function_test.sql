...
values
  ('30000000-0000-0000-0000-000000000003', 'Invite Member Event Group', 'event', '2026-08-01', '2026-08-03', '00000000-0000-0000-0000-000000000041');
...
values
  ...
  ('30000000-0000-0000-0000-000000000003', 'EVENTGROUPCODE', '00000000-0000-0000-0000-000000000041');
...
-- =====================================================================
-- 6. イベントグループの招待コードでは参加できない(mode<>group)
-- =====================================================================
set local role authenticated;
set local request.jwt.claims to '{"sub": "00000000-0000-0000-0000-000000000042"}';

select throws_ok(
  $$ select public.invite_member('EVENTGROUPCODE') $$,
  null,
  null,
  'invite_member rejects an invite code issued for an event group'
);
