...
void main() {
  group('emailVerificationRedirect', () {
    ...
    test(
      ...
      () {
        const user =
            PublicUserRow(authProvider: 'google', emailVerified: false);
    ...
    test('does not redirect a verified email-provider user', () {
      ...
      final result = emailVerificationRedirect(user: user, location: '/some-future-screen');
      expect(result, isNull);
    });
    ...
    test('does not redirect when already on an allow-listed path', () {
      ...
      final result = emailVerificationRedirect(user: user, location: '/verify-pending');
      expect(result, isNull);
    });
